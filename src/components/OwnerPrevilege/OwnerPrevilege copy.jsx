  ...
  let getData = async () => {
    try {
      ...
      if (presaleAccount) {
        ...
        let usdtRaised = Number(presaleAccount?.account?.usdtRaised);
        let usdcRaised = Number(presaleAccount?.account?.usdcRaised);
        let solRaised = Number(presaleAccount?.account?.solRaised) * USD;
              ...
              {StepperType.map((data, index) => (
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  ...
                  >
                    <Box
                      sx={{
                        ...
                        fontFamily: "Sofia Sans",
                        alignItems: "center",
                        borderLeft: index != 0 ? "1px solid gray" : null,
                        width: "30px",
                        height: "30px",
                        backgroundImage:
                          index == 0
                  ...
                  <Box
                    ...
                    height={"3px"}
                    sx={{
                      backgroundColor: index == 0 ? "#933FFE" : "#5A5A5A",
                      position: "relative",
                      top: "-15px",
      ...
      {/* <Box>
        <Container maxWidth="sm" sx={{ mt: 10 }}>
          ...
          <Typography
            ...
            my={3}
          >
            Earn a 10% bonus! Share your unique referral link below. Each time
            someone buys through your link, you bag a 10% commission paid out
            instantly in $USDT.
          </Typography>
        </Container>
      </Box>
            ...
            >
              ...
              {publicKey && (
                <CopyToClipboard
                  text={
                    publicKey
                      ? window.location.origin + `/?bebe_ref=${publicKey}`
                      : ""
                  }
                  onCopy={() => {
                    if (publicKey) {
                ...
                >
                  <Box position="relative" sx={{ cursor: "pointer" }}>
                    <Tooltip
                      title={refCopied ? "Copied!" : "Copy Link"}
                      arrow
                      disableTouchListener
                    >
                      <ContentCopyIcon sx={{ color: "#91EB4A" }} />
                    </Tooltip>
                  </Box>
                </CopyToClipboard>
              )}
